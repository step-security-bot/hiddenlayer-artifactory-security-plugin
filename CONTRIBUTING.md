# Contributing to `HiddenLayer Artifactory Model Security User Plugin`

Thank you for your interest in contributing to `HiddenLayer Artifactory Model Security User Plugin`! We welcome contributions from the community to help improve and grow this project. By contributing, you agree to abide by our [Code of Conduct](link-to-code-of-conduct.md).
...
To get started with contributing to `HiddenLayer Artifactory Model Security User Plugin`, follow these steps:
...
Thank you for contributing to `HiddenLayer Artifactory Model Security User Plugin`!
